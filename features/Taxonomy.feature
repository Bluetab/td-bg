Feature: Taxonomy administration
  ...
  Scenario Outline: Modifying a Data Domain and seeing the new version by Domain Manager
    ...
    Then the system returns a result with code "<result>"
    And if result <result> is "Ok", the user "<user>" is able to see the Data Domain "My Domain" with following data:
      | Description |
      | Second version of My Domain |
    And if result <result> is not "Ok", the user "<user>" is able to see the Data Domain "My Domain" with following data:
      | Description |
      | First version of My Domain |
  ...
  Scenario Outline: Modifying a Domain Group and seeing the new version by Group Manager
    ...
    Then the system returns a result with code "<result>"
    And if result <result> is "Ok", the user "<user>" is able to see the Domain Group "My Child Group" with following data:
      | Description |
      | Second version of My Child Group |
    And if result <result> is not "Ok", the user "<user>" is able to see the Data Domain "My Child Group" with following data:
      | Description |
      | First version of My Child Group |
