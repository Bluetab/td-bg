defmodule TdBgWeb.SwaggerDefinitions do
  ...
  def business_concept_definitions do
    %{
      ...
      BusinessConceptTaxonomyResponse:
        swagger_schema do
          properties do
            data(
              Schema.new do
      ...
      BusinessConceptTaxonomyEntries:
        swagger_schema do
        ...
        swagger_schema do
          ...
          properties do
            ...
            roles(
              ...
              items: Schema.ref(:BusinessConceptAclEntry),
              required: true
            )
          end
        end,
      BusinessConceptAclEntry:
        swagger_schema do
