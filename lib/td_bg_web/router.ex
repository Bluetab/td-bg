defmodule TdBgWeb.Router do
  ...
  scope "/api", TdBgWeb do
    ...
    get "/business_concept_versions/csv", BusinessConceptVersionController, :csv
    ...
    resources "/business_concepts", BusinessConceptController, except: [:index, :new, :edit, :delete] do
