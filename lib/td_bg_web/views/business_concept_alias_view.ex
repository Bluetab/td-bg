defmodule TdBgWeb.BusinessConceptAliasView do
  ...
  def render("index.json", %{business_concept_aliases: business_concept_aliases, hypermedia: hypermedia}) do
    render_many_hypermedia(business_concept_aliases, hypermedia, BusinessConceptAliasView, "business_concept_alias.json")
  end
  ...
  def render("show.json", %{business_concept_alias: business_concept_alias, hypermedia: hypermedia}) do
    render_one_hypermedia(business_concept_alias, hypermedia, BusinessConceptAliasView, "business_concept_alias.json")
  end
