defmodule TdBg.Repo.Migrations.RecordEmbeddings do
  use Ecto.Migration
  ...
  def change do
    ...
    create(index(:record_embeddings, [:business_concept_version_id]))
    create(index(:record_embeddings, [:business_concept_version_id, :collection], unique: true))
  end
end
