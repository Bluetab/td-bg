defmodule TdBg.ElasticsearchMock do
  @moduledoc """
  ...
  @impl true
  def request(_config, :post, "/concepts/_search", data, _opts) do
    data
    |> do_search()
  ...
  defp create_term_filter(%{business_concept_id: business_concept_id})
       when is_binary(business_concept_id) do
