  ...
  Scenario Outline: Create an alias for a business concept
    ...
    When "<user>" tries to create a new alias "My Synonym Term" for business concept with name "My Business Term" of type "Business_Term"
    Then the system returns a result with code "<result>"
    And if <result> is "Created", user <user> is able to see following list of aliases for business concept with name "My Business Term" of type "Business_Term"
      | name            |
      | My Synonym Term |
  ...
  Scenario Outline: Delete alias for a business concept
    ...
    And business concept with name "My Business Term" of type "Business_Term" has an alias "My Second Synonym Term"
    When <user> tries to delete alias "My Synonym Term" for business concept with name "My Business Term" of type "Business_Term"
    Then the system returns a result with code "<result>"
    And if <result> is "No Content", user <user> is able to see following list of aliases for business concept with name "My Business Term" of type "Business_Term"
      | name                   |
      | My Second Synonym Term |
    And if <result> is not "No Content", user <user> is able to see following list of aliases for business concept with name "My Business Term" of type "Business_Term"
      | name                   |
      | My Synonym Term        |
      | My Second Synonym Term |
  ...
  Scenario: User should not be able to create an alias with same type and name as an existing business concept
    ...
    When "app-admin" tries to create a new alias "Second Business Term" for business concept with name "My Business Term" of type "Business_Term"
    Then the system returns a result with code "Unprocessable Entity"
    And user "app-admin" is able to see following list of aliases for business concept with name "My Business Term" of type "Business_Term"
      | name |
